...
from src.functions.dlq_api import bp as dlq_api_bp
from src.functions.event_api import bp as event_api_bp
from src.functions.event_consumer import bp as event_consumer_bp
...
# Blueprint 등록
app.register_functions(dlq_api_bp)
app.register_functions(event_api_bp)
app.register_functions(event_consumer_bp)
